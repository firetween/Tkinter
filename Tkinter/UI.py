...
btn=Button(aken,text="Решить",font="Arial 20",bg="green")
ent=Entry(aken,width=5,font="Arial 20",fg="green",bg="lightblue")
lbl2=Label(aken,text=" x**2+ ",width=4,font="Arial 20",fg="green") 
ent2=Entry(aken,width=4,font="Arial 20",fg="green",bg="lightblue")
lbl3=Label(aken,text="x+",width=3,font="Arial 20",fg="green")
ent3=Entry(aken,width=4,font="Arial 20",fg="green",bg="lightblue")
